...
type NewsServiceClient interface {
	GetNews(ctx context.Context, in *EmptyParams, opts ...grpc.CallOption) (*ItemResponse, error)
}
...
func (c *newsServiceClient) GetNews(ctx context.Context, in *EmptyParams, opts ...grpc.CallOption) (*ItemResponse, error) {
...
type NewsServiceServer interface {
	GetNews(context.Context, *EmptyParams) (*ItemResponse, error)
...
func (UnimplementedNewsServiceServer) GetNews(context.Context, *EmptyParams) (*ItemResponse, error) {
...
func _NewsService_GetNews_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NewsServiceServer).GetNews(ctx, req.(*EmptyParams))
	}
